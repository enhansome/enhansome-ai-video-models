...
* [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 28,115 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-08 — curated hub of open generative-media tools and pipelines
* [ai-creator-academy](https://github.com/Anil-matcha/ai-creator-academy) ⭐ 2,004 | 🐛 0 | 📅 2026-08-21 — free curriculum teaching creators how to monetize the models compared in this list
* [Text-To-Video-AI](https://github.com/SamurAIGPT/Text-To-Video-AI) ⭐ 821 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-08-24 — generate a finished video from a text prompt end-to-end
* [Open-AI-Micro-Drama-Generator](https://github.com/Anil-matcha/Open-AI-Micro-Drama-Generator) ⭐ 486 | 🐛 1 | 🌐 Python | 📅 2026-08-02 — multi-scene AI micro-drama pipeline
* [Seedance-2-API](https://github.com/Anil-matcha/Seedance-2-API) ⭐ 345 | 🐛 1 | 🌐 Python | 📅 2026-09-07 — Python wrapper for ByteDance Seedance 2
* [awesome-seedance-2.5-api-prompts](https://github.com/Anil-matcha/awesome-seedance-2.5-api-prompts) ⭐ 314 | 🐛 5 | 📅 2026-09-07 — prompt library for Seedance 2.5
...
* [awesome-minimax-h3-prompts](https://github.com/Anil-matcha/awesome-minimax-h3-prompts) ⭐ 15 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 — Prompt gallery with runnable MiniMax H3 video examples.
...
* [awesome-uncensored-ai-video-models](https://github.com/Anil-matcha/awesome-uncensored-ai-video-models) ⭐ 5 | 🐛 0 | 📅 2026-08-05 — Filtering-, access-, and licensing-focused companion catalog for local and hosted video model variants
...
* **[VBench / VBench-2.0](https://github.com/Vchitect/VBench) ⭐ 1,765 | 🐛 73 | 🌐 Python | 📅 2026-08-21** — 16-dimension automated quality benchmark
...
*Maintained alongside [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 28,115 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-08. Found it useful? ⭐ the repo.*
