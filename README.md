...
* [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 27,260 | 🐛 31 | 🌐 JavaScript | 📅 2026-08-27 — curated hub of open generative-media tools and pipelines
...
* [Open-AI-Micro-Drama-Generator](https://github.com/Anil-matcha/Open-AI-Micro-Drama-Generator) ⭐ 471 | 🐛 1 | 🌐 Python | 📅 2026-08-02 — multi-scene AI micro-drama pipeline
* [Seedance-2-API](https://github.com/Anil-matcha/Seedance-2-API) ⭐ 342 | 🐛 1 | 🌐 Python | 📅 2026-08-03 — Python wrapper for ByteDance Seedance 2
...
* [awesome-minimax-h3-prompts](https://github.com/Anil-matcha/awesome-minimax-h3-prompts) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 — Prompt gallery with runnable MiniMax H3 video examples.
* [Veo-4-API](https://github.com/Anil-matcha/Veo-4-API) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-08-02 — Python wrapper for Google Veo 4
* [wan-3.0-comfyui](https://github.com/Anil-matcha/wan-3.0-comfyui) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-08-25 — ComfyUI custom nodes for Wan 3.0 text-to-image, image edit, text-to-video, and image-to-video via MuAPI.
...
* [Gemini-Omni-1.1-Flash-API](https://github.com/Anil-matcha/Gemini-Omni-1.1-Flash-API) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-27 — Python SDK and MCP server for Google's newly announced Gemini Omni 1.1 Flash update.
...
* **[VBench / VBench-2.0](https://github.com/Vchitect/VBench) ⭐ 1,748 | 🐛 73 | 🌐 Python | 📅 2026-08-21** — 16-dimension automated quality benchmark
...
*Maintained alongside [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 27,260 | 🐛 31 | 🌐 JavaScript | 📅 2026-08-27. Found it useful? ⭐ the repo.*
