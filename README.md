...
* [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 29,036 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-19 — curated hub of open generative-media tools and pipelines
...
* [Text-To-Video-AI](https://github.com/SamurAIGPT/Text-To-Video-AI) ⭐ 830 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-08-24 — generate a finished video from a text prompt end-to-end
* [Open-AI-Micro-Drama-Generator](https://github.com/Anil-matcha/Open-AI-Micro-Drama-Generator) ⭐ 506 | 🐛 2 | 🌐 Python | 📅 2026-08-02 — multi-scene AI micro-drama pipeline
* [Seedance-2-API](https://github.com/Anil-matcha/Seedance-2-API) ⭐ 350 | 🐛 1 | 🌐 Python | 📅 2026-09-07 — Python wrapper for ByteDance Seedance 2
* [awesome-seedance-2.5-api-prompts](https://github.com/Anil-matcha/awesome-seedance-2.5-api-prompts) ⭐ 318 | 🐛 5 | 📅 2026-09-07 — prompt library for Seedance 2.5
...
* **[VBench / VBench-2.0](https://github.com/Vchitect/VBench) ⭐ 1,791 | 🐛 74 | 🌐 Python | 📅 2026-08-21** — 16-dimension automated quality benchmark
...
*Maintained alongside [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 29,036 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-19. Found it useful? ⭐ the repo.*
